      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        <div className="flex flex-col md:flex-row justify-between items-center border-t border-purple-500/10 pt-8">
          ...
          <div className="flex gap-4">
            <a href="#" className="text-secondary hover:text-white hover:scale-110 transition-all w-8 h-8 flex items-center justify-center rounded-full border border-gray-600" aria-label="X">
            ...
            <a href="#" className="text-secondary hover:text-white hover:scale-110 transition-all w-8 h-8 flex items-center justify-center rounded-full border border-gray-600" aria-label="Instagram">
            ...
            <a href="#" className="text-secondary hover:text-white hover:scale-110 transition-all w-8 h-8 flex items-center justify-center rounded-full border border-gray-600" aria-label="Discord">
